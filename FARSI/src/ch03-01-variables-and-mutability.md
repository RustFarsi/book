...
همانطور که در بخش 2 گفته شد متغییرها بصورت پیش‌فرض غیر قابل تغییر هستند.این موضوع یکی از اقداماتی است که در Rust تعبیه شده تا کد خود را بنحوی بنویسید که از امتیاز کد امن که در Rust عرضه شده و همچنین از همزمانی (concurrency) راحت بهره ببرید.با این حال امکان اینکه متغییرعا را بنحوی تعریف کنید که قابل تغییر داشته باشند وجود دارد.بگذارید بررسی کنیم چرا و چگونه Rust شما را به استفاده از متغییرعای غیر قابل تغییر (immutable) ترغیب می‌کند و چرا گاهی اوقات ممکن است بخواعید از متغییرهای تغییر پذیر(mutable) استفاده کنید.
